...
1. Используя пример выше, напишите `Function`, который принимает на вход целое число N от 0 до 9 и возвращает целое число 2^N. Введите массив из 10 целых чисел и проверьте работу метода.
